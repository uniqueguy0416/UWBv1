...
anchor_positions = [
    (0.00,  0.00, 0.00),  # Anchor6
    (5.00,  0.00, 0.00),  # Anchor7 (故障)
    (5.00,  8.00, 2.00),  # Anchor8
    (2.00,  4.00, 2.00)   # Anchor9
]
...
def main():
    ...
    csv_path = os.path.join(output_dir, 'uwb_三角形內點.csv')
    xlsx_path = os.path.join(output_dir, 'uwb_三角形內點.xlsx')
